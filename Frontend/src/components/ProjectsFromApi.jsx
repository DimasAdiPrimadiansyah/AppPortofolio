...
const ProjectsFromApi = () => {
    ...
    return (
        <section className="relative min-h-screen bg-profile-background text-white py-12 px-4 sm:px-6 md:px-12 lg:px-20 overflow-hidden">
            {/* Background Blobs */}
...
export default ProjectsFromApi;
